...
public class Item : MonoBehaviour
{
    ...
    public void Initialize()
    {
        ...
        var droopPosition = transform.localPosition + new Vector3(Random.Range(-1f, 1f), 0, Random.Range(-1f, 1f));
        transformCache.DOLocalMove(droopPosition, 0.5f);
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            Debug.Log(item.Type + "ªò" + item.Number +"ËÁá¶ò¥");
        }
        Destroy(gameObject);
    }
}
